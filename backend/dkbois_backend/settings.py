"""
Django settings for dkbois_backend project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-39b$5cn6c2bey_p66jy#d2=^3r&z3w-#rky8md(&ek)yqsl&2j')
...
ROOT_URLCONF = 'dkbois_backend.urls'
...
WSGI_APPLICATION = 'dkbois_backend.wsgi.application'
